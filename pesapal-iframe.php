...
// $callback_url = 'pesapal-ipn-listener.php'; //redirect url, the page that will handle the response from pesapal.
$callback_url = 'https://ptsv2.com/t/ild6k-1655575748/post';
...
?>
<script>
    window.open("<?php echo $iframe_src; ?>");
</script>
